...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://xrootd-cms.infn.it//store/data/Run2015C_25ns/FSQJets3/AOD/16Dec2015-v1/50000/062D1243-AEAF-E511-A5A2-549F35AD8BF0.root')
...
#process.EflowTree._Parameterizable__setParameters(CommonFSQFramework.Core.JetViewsConfigs.get(["JetViewPFAK4CHS"]))
...
if isData: process.EflowTree._Parameterizable__setParameters(CommonFSQFramework.Core.TriggerResultsViewsConfigs.get(["ZeroBiasWithPSRun2015D","L1GTriggerResultsView"]))
