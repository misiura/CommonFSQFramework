...
dsFile="CommonFSQFramework/Skim/python/ds_FSQJets3_Run2015C.txt"
...
def numEvents(ds):
    ...
    if "QCD_Pt-10to35_TuneCUETHS1_13TeV-herwigpp" in name(ds): return 997904
    if "QCD_Pt-35toInf_TuneCUETHS1_13TeV-herwigpp" in name(ds): return 976276
...
def GT(ds):
    ...
    if isData(ds) and "Run2015C_25ns-16Dec2015-v1" in ds: return "76X_dataRun2_v15"
	
    # 3.8T MC GT
    if "NoPU_castor_MCRUN2_74_V8" in ds: return "MCRUN2_74_V8" 
    if "NoPURawReco_castor_MCRUN2_74_V8B" in ds: return "MCRUN2_74_V8B"
    if "PU25nsData2015v1_castor_76X" in ds: return "76X_mcRun2_asymptotic_v12"
...
def XS(ds):
    ...
    s["QCD_Pt-35toInf_TuneCUETHS1_13TeV-herwigpp"]=18240000
    s["QCD_Pt-10to35_TuneCUETHS1_13TeV-herwigpp"]=1545000000
